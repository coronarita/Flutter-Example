...
with SingleTickerProviderStateMixin{
  ...
  TabController? controller; // null safety 데이터 타입 옆(우측)에 해결해 줘야 함
  List<Animal> animalList = List.empty(growable:true); //List 관련 null safety 는 list.empty(growable:true)로 해결
  @override
  void initState() {
    super.initState();
  ...
  @override
  void dispose(){ //탭이 애니메이션이기에 메모리 누수를 방지하기 위함
  controller!.dispose(); //The method 'dispose' can't be unconditionally invoked because the receiver can be 'null'.
  super.dispose();
  }
}
