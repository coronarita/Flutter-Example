...
class SecondApp extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SecondApp(); // 반환값을 한줄로 표현하고자 할 때 => 화살표 이용
      ...
      body: Container(
        child: Center(
          child: Column(
            ...
            children: <Widget>[
            TextField(                        //사용자가 동물값을 입력할 필드 추가, 및 반환값 변수 final로 선언
...
//              mainAxisAlignment : MainAxisAlignment.spaceAround,
  ...
  _radioChange(int? value){ //타입에는 ?로
  setState((){
    _radioValue = value!;   // 반환받는 것에는 뒤!로
  });
  }
  getKind(int? radioValue){ // 선택값을 문자열로 반환 - firstPage에 목록추가용으로.
    switch(radioValue){
      case 0:
        return "양서류";
      case 1:
